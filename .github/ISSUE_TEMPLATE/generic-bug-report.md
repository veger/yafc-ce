...
- Please check the issues of [Yafc-ce](https://github.com/Yafc-CE/yafc-ce/issues) and the [original Yafc](https://github.com/ShadowTheAge/yafc/issues) to see if your problem is not a duplicate of another open or closed issue.
